...
AppId={{8D197083-539E-4F3B-A598-06B6FF2CACF6}
AppName={#MyAppName}
...
LicenseFile=C:\Users\mina987\Documents\GitHub\FridgeLabReport\LICENSE
; Uncomment the following line to run in non administrative install mode (install for current user only).
;PrivilegesRequired=lowest
OutputBaseFilename=FridgeLabReportSetup
...
[Files]
Source: "C:\Users\mina987\Documents\GitHub\FridgeLabReport\bin\Release\net10.0-windows\win-x64\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
